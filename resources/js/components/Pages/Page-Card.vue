<template>
    <fragment>
        ...
        <div id="top-level" class="site-container">
            ...
            <main>
                <div class="bread-crumbs ">
                    ...
                    <a href="#" aria-current="location">Смартфон Apple iPhone 11 Pro Max 64GB</a>
                </div>
                <div class="card-preview">
                    <div class="product-card-wrap">
                        <div data-vendor-code="064254" class="product-card card-preview__card product-card--m-icon">
                            <div class="product-card__bonuses">
                                <div class="bonus-icon priority-2">
                                    <img src="img/content/icon/discount.svg" width="70" height="70" alt="бонус">
                                </div>
                            ...
                            <div class="card-preview__slider slider-container">
                                <div class="preview-slider-container slider-container">
                                    <div class="preview-slider swiper-wrapper">
                                        <div class="preview-slider-img fast-order-img swiper-slide">
                                            <picture>
                                                <!-- 1x-179px/108px 2x-358px/216px -->
                                                <source type="image/webp"
                                                        srcset="img/content/preview/phone-apple0.webp 1x, img/content/preview/phone-apple0@2x.webp 2x">
                                                <img class=content-img src="img/content/preview/phone-apple0.jpg"
                                                     srcset="img/content/preview/phone-apple0@2x.jpg 2x" width="179"
                                                     height="108"
                                                     alt="телефон Sumsung A20" loading=lazy decoding=async>
                                            </picture>
                                        </div>
                                        <div class="preview-slider-img fast-order-img swiper-slide">
                                            <picture>
                                                <!-- 1x-179px/108px 2x-358px/216px -->
                                                <source type="image/webp"
                                                        srcset="img/content/preview/phone-apple1.webp 1x, img/content/preview/phone-apple1@2x.webp 2x">
                                                <img class=content-img src="img/content/preview/phone-apple1.jpg"
                                                     srcset="img/content/preview/phone-apple1@2x.jpg 2x" width="179"
                                                     height="108"
                                                     alt="телефон Sumsung A20" loading=lazy decoding=async>
                                            </picture>
                                        </div>
                                        <div class="preview-slider-img fast-order-img swiper-slide">
                                            <picture>
                                                <!-- 1x-179px/108px 2x-358px/216px -->
                                                <source type="image/webp"
                                                        srcset="img/content/preview/phone-apple2.webp 1x, img/content/preview/phone-apple2@2x.webp 2x">
                                                <img class=content-img src="img/content/preview/phone-apple2.jpg"
                                                     srcset="img/content/preview/phone-apple2@2x.jpg 2x" width="179"
                                                     height="108"
                                                     alt="телефон Sumsung A20" loading=lazy decoding=async>
                                            </picture>
                                        </div>
                                        <div class="preview-slider-img fast-order-img swiper-slide">
                                            <picture>
                                                <!-- 1x-179px/108px 2x-358px/216px -->
                                                <source type="image/webp"
                                                        srcset="img/content/preview/phone-apple3.webp 1x, img/content/preview/phone-apple3@2x.webp 2x">
                                                <img class=content-img src="img/content/preview/phone-apple3.jpg"
                                                     srcset="img/content/preview/phone-apple3@2x.jpg 2x" width="179"
                                                     height="108"
                                                     alt="телефон Sumsung A20" loading=lazy decoding=async>
                                            </picture>
                                        </div>
                                        <div class="preview-slider-img fast-order-img swiper-slide">
                                            <picture>
                                                <!-- 1x-179px/108px 2x-358px/216px -->
                                                <source type="image/webp"
                                                        srcset="img/content/preview/phone-apple4.webp 1x, img/content/preview/phone-apple4@2x.webp 2x">
                                                <img class=content-img src="img/content/preview/phone-apple4.jpg"
                                                     srcset="img/content/preview/phone-apple4@2x.jpg 2x" width="179"
                                                     height="108"
                                                     alt="телефон Sumsung A20" loading=lazy decoding=async>
                                            </picture>
                                        </div>
                                        <div class="preview-slider-img fast-order-img swiper-slide">
                                            <picture>
                                                <!-- 1x-179px/108px 2x-358px/216px -->
                                                <source type="image/webp"
                                                        srcset="img/content/preview/phone-apple5.webp 1x, img/content/preview/phone-apple5@2x.webp 2x">
                                                <img class=content-img src="img/content/preview/phone-apple5.jpg"
                                                     srcset="img/content/preview/phone-apple5@2x.jpg 2x" width="179"
                                                     height="108"
                                                     alt="телефон Sumsung A20" loading=lazy decoding=async>
                                            </picture>
                                        </div>
                                        <div class="preview-slider-img fast-order-img swiper-slide">
                                            <picture>
                                                <!-- 1x-179px/108px 2x-358px/216px -->
                                                <source type="image/webp"
                                                        srcset="img/content/preview/phone-apple6.webp 1x, img/content/preview/phone-apple6@2x.webp 2x">
                                                <img class=content-img src="img/content/preview/phone-apple6.jpg"
                                                     srcset="img/content/preview/phone-apple6@2x.jpg 2x" width="179"
                                                     height="108"
                                                     alt="телефон Sumsung A20" loading=lazy decoding=async>
                                            </picture>
                                        </div>
                                ...
                                <div class="preview-slider-navigation">
                                    ...
                                    <div class="preview-slider-thumb slider-container">
                                        <div class="preview-slider-thumb__wrap swiper-wrapper">
                                            <div class="preview-slider-thumb__img swiper-slide">
                                                <picture>
                                                    <!-- 1x-80px/80px 2x-160px/160px -->
                                                    <source type="image/webp"
                                                            srcset="img/content/preview/phone-apple0.webp 1x, img/content/preview/phone-apple0@2x.webp 2x">
                                                    <img class=content-img src="img/content/preview/phone-apple0.jpg"
                                                         srcset="img/content/preview/phone-apple0@2x.jpg 2x" width="80"
                                                         height="80"
                                                         alt="телефон Sumsung A20" loading=lazy decoding=async>
                                                </picture>
                                            </div>
                                            <div class="preview-slider-thumb__img swiper-slide">
                                                <picture>
                                                    ...
                                                    <source type="image/webp"
                                                            srcset="img/content/preview/phone-apple1.webp 1x, img/content/preview/phone-apple1@2x.webp 2x">
                                                    <img class=content-img src="img/content/preview/phone-apple1.jpg"
                                                         srcset="img/content/preview/phone-apple1@2x.jpg 2x" width="80"
                                                         height="80"
                                                         alt="телефон Sumsung A20" loading=lazy decoding=async>
                                                </picture>
                                            </div>
                                            <div class="preview-slider-thumb__img swiper-slide">
                                                <picture>
                                                    ...
                                                    <source type="image/webp"
                                                            srcset="img/content/preview/phone-apple2.webp 1x, img/content/preview/phone-apple2@2x.webp 2x">
                                                    <img class=content-img src="img/content/preview/phone-apple2.jpg"
                                                         srcset="img/content/preview/phone-apple2@2x.jpg 2x" width="80"
                                                         height="80"
                                                         alt="телефон Sumsung A20" loading=lazy decoding=async>
                                                </picture>
                                            </div>
                                            <div class="preview-slider-thumb__img swiper-slide">
                                                <picture>
                                                    ...
                                                    <source type="image/webp"
                                                            srcset="img/content/preview/phone-apple3.webp 1x, img/content/preview/phone-apple3@2x.webp 2x">
                                                    <img class=content-img src="img/content/preview/phone-apple3.jpg"
                                                         srcset="img/content/preview/phone-apple3@2x.jpg 2x" width="80"
                                                         height="80"
                                                         alt="телефон Sumsung A20" loading=lazy decoding=async>
                                                </picture>
                                            </div>
                                            <div class="preview-slider-thumb__img swiper-slide">
                                                <picture>
                                                    ...
                                                    <source type="image/webp"
                                                            srcset="img/content/preview/phone-apple4.webp 1x, img/content/preview/phone-apple4@2x.webp 2x">
                                                    <img class=content-img src="img/content/preview/phone-apple4.jpg"
                                                         srcset="img/content/preview/phone-apple4@2x.jpg 2x" width="80"
                                                         height="80"
                                                         alt="телефон Sumsung A20" loading=lazy decoding=async>
                                                </picture>
                                            </div>
                                            <div class="preview-slider-thumb__img swiper-slide">
                                                <picture>
                                                    ...
                                                    <source type="image/webp"
                                                            srcset="img/content/preview/phone-apple5.webp 1x, img/content/preview/phone-apple5@2x.webp 2x">
                                                    <img class=content-img src="img/content/preview/phone-apple5.jpg"
                                                         srcset="img/content/preview/phone-apple5@2x.jpg 2x" width="80"
                                                         height="80"
                                                         alt="телефон Sumsung A20" loading=lazy decoding=async>
                                                </picture>
                                            </div>
                                            <div class="preview-slider-thumb__img swiper-slide">
                                                <picture>
                                                    ...
                                                    <source type="image/webp"
                                                            srcset="img/content/preview/phone-apple6.webp 1x, img/content/preview/phone-apple6@2x.webp 2x">
                                                    <img class=content-img src="img/content/preview/phone-apple6.jpg"
                                                         srcset="img/content/preview/phone-apple6@2x.jpg 2x" width="80"
                                                         height="80"
                                                         alt="телефон Sumsung A20" loading=lazy decoding=async>
                                                </picture>
                                            </div>
                                    ...
                                    <button
                                        class="banner__btn btn-slider preview-slider-btn-next  btn-slider--next arrow arrow--right"
                                        type="button" aria-label="следующий слайд"></button>
                                </div>
                            </div>
                            <div class="card-preview__title">
                                ...
                                <div class="card-preview__for-desktop">
                                    <a class="card-preview__rating-anchor anchor-link" href="#feedback-tab">
                                        <span class="star-rating star-rating--4"></span>
                                        <span class="card-preview__feedback">243 отзыва</span>
                                    </a>
                                    <div class="product-card__icons">
                                        <button class="product-card__icon icon-type-equal" type="button"
                                                aria-label="добавить к сравнению">
                            ...
                            <div class="card-preview__price-rating">
                                <s class="product-card__old-price">53 999₽</s>
                                <b class="product-card__price">32 230₽</b>
                                <a class="star-rating star-rating--5 anchor-link" href="#feedback-tab"></a>
                            </div>
                            <div class="card-preview__buy">
                  ...
                  567&nbsp;</span> руб. в мес</a>
                            ...
                            <div class="card-preview__footer">
                                <div class="card-preview__fieldset card-preview__fieldset--memory">
                                    <h3 class="card-preview__fieldset-title">Встроенная память</h3>
                                    <input id="memory-64" type="radio" name="memory" value="64gb" checked>
                                    <label for="memory-64" class="card-preview__fieldset-item">64GB</label>
                                    <input id="memory-128" type="radio" name="memory" value="128gb">
                                    <label for="memory-128" class="card-preview__fieldset-item">128GB</label>
                                    <input id="memory-512" type="radio" name="memory" value="512gb">
                                    <label for="memory-512" class="card-preview__fieldset-item">512GB</label>
                                </div>
                                <div class="card-preview__fieldset card-preview__fieldset--color">
                                    ...
                                    <label for="color-red" class="card-preview__fieldset-item" aria-label="красный цвет"
                                           style="background-color: #D7364F"></label>
                                    <input id="color-gray" type="radio" name="color" value="#B4B4B4">
                                    ...
                                    <div class="card-preview__fieldset-title">
                                        <h3>Цвет товара:</h3>
                                        <div class="card-preview__palette">
                                            <span>Голубой</span>
                                ...
                                <a class="card-preview__all-features anchor-link" href="#features-tab">Посмотреть все
                                    характеристики</a>
                                <p class="card-preview__assets">В наличии</p>
                            </div>
                        </div>
                ...
                <div class="card-special">
                    <div class="card-special__col">
                        ...
                        <dl class="card-special__list">
                            <dt>Доставка курьером, завтра, 11 сентября</dt>
                            <dd>Бесплатно</dd>
                            <dt>Самовывоз, сегодня, 10 сентября</dt>
                            <dd>390p.</dd>
                            <dt>Доставка ТК по РФ</dt>
                            <dd>390p.</dd>
                        </dl>
                    </div>
                    <div class="card-special__col">
                        <h3 class="card-special__title">Гарантии
                            <svg width="24" height="24">
                                <use href="#icon-garanty"></use>
                            </svg>
                        </h3>
                        <dl class="card-special__list">
                            <dt>Стандартная гарантия 12 мес.</dt>
                            <dd>Гарантия от производителя</dd>
                            <dt>14 дней на возврат</dt>
                            <dd>Если вы обнаружили брак или вам не подошла вещь, вы можете вернуть её нам.</dd>
                        </dl>
                    </div>
                    <div class="card-special__col">
                        <h3 class="card-special__title">Способы оплаты
                            <svg width="24" height="24">
                                <use href="#icon-info"></use>
                            </svg>
                        </h3>
                        <dl class="card-special__list">
                            <dt>Банковская карта</dt>
                            <dd>Visa, MasterCard, Maestro, American Express</dd>
                            <dt>Наличная оплата</dt>
                            <dd>Курьеру, в пункте выдачи</dd>
                            <dt>В кредит/рассрочку</dt>
                            <dd>Без переплат</dd>
                        </dl>
                    </div>
                </div>
                <div class="card-main">
                    <div class="card-main__set-wrap">
                        <div class="set-cards slider-container">
                            <h2>Выгодно вместе</h2>
                            <div class="set-cards__container">
                                <div class="set-cards__slider">
                                    <div class="set-cards__item">
                                        <div class="set-cards__img-wrap">
                                            <picture>
                                                <!-- 1x-165px/108px 2x-330px/216px -->
                                                <source type="image/webp"
                                        ...
                                        <div class="set-cards__img-wrap">
                                            <picture>
                                                ...
                                                <img class=content-img src="img/content/phone-small.jpg"
                                                     srcset="img/content/phone-small@2x.jpg 2x" width="165" height="108"
                                                     alt="apple watch"
                                    ...
                                    <div class="set-cards__item">
                                        <div class="set-cards__price-wrp">
                                            <b class="set-cards__price">32 230₽</b>
                                            <s class="set-cards__old-price">53 999₽</s>
                                        </div>
                                        <button class="set-cards__btn set-cards__btn--complex btn btn-purple add-to-cart"
                                            ...
                                            <span class="counter counter--red">Купить комплект</span>
                                        </button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-main__body">
                        <section class="product-type card-main__slider">
                            <div class="product-type__header">
                                <h2>С этим обычно покупают<sup class="title-counter">135</sup></h2>
                            </div>
                        ...
                        <div class="card-main__accordion accordion">
                            <h3 class="card-main__accordion-title accordion__title arrow arrow--down ">
                                О товаре
                            </h3>
                            ...
                            <div class="accordion__content card-main__accordion-content ">
                                ...
                                <dl class="card-main__features">
                                    ...
                                    <dt>Поддержка Bluetooth</dt>
                                    <dd>Bluetooth 5.0</dd>
                                    <dt>Поддержка Wi-Fi</dt>
                                    <dd>Wi-Fi 802.11ax (Wi-Fi 6) с технологией MIMO 2×2</dd>
                                    <dt>Поддержка 3G/4G/LTE</dt>
                                    <dd>Gigabit Class LTE с технологиями MIMO 4×4 и LAA</dd>
                                </dl>
                                <h4>Питание</h4>
                                <dl class="card-main__features">
                                    <dt>Время работы</dt>
                                ...
                                <h4>Мультимедийные возможности</h4>
                                <dl class="card-main__features">
                                    <dt>Фотокамера</dt>
                                    <dd>Система трёх камер 12 Мп: сверхширокоугольная, широкоугольная и телефото /
                                        Сверхширокоугольная:
                            ...
                            <div class="accordion__content card-main__accordion-content ">
                                <div class="card-main__iframe"></div>
                            </div>
                        </div>
                    </div>
                </div>
                <section class="product-type">
                    <div class="product-type__header">
                        <h2>Похожие товары<sup class="title-counter">135</sup></h2>
                    </div>
                    <div class="product-card-container slider-container">
                        <div class="product-card-list swiper-wrapper">
                            <div class="product-card-wrap swiper-slide">
                ...
                <section class="product-type">
                    <div class="product-type__header">
                        <h2>Вы уже смотрели<sup class="title-counter">135</sup></h2>
                    </div>
                    <div class="product-card-container slider-container">
                        <div class="product-card-list swiper-wrapper">
                            <div class="product-card-wrap swiper-slide">
                ...
                <div class="options-slider slider-container">
                    <div class="options-slider__wrapper swiper-wrapper">
                        <div class="options-slider__slide swiper-slide">
                            <svg width="45" height="45">
                                <use href="#icon-location"></use>
                            </svg>
                            <strong>100500 пунктов выдачи</strong>
                            <p>Покупки можно забрать где угодно</p>
                        </div>
                        <div class="options-slider__slide swiper-slide">
                            <svg width="45" height="45">
                                <use href="#icon-card"></use>
                            </svg>
                            <strong>Оплата любым способом</strong>
                            <p>5 способов оплаты для вашего удобства</p>
                        </div>
                        <div class="options-slider__slide swiper-slide">
                            <svg width="45" height="45">
                                <use href="#icon-clock"></use>
                            </svg>
                            <strong>Онлайн кредит от 5 минут</strong>
                            <p>Просто и быстро: нужен только паспорт</p>
                        </div>
                        <div class="options-slider__slide swiper-slide">
                            <svg width="45" height="45">
                            ...
                            <p>Поможем с ремонтом товара и предоставим аппарат на замену.</p>
                        </div>
                        <div class="options-slider__slide swiper-slide">
                            <svg width="45" height="45">
                                <use href="#icon-airplane"></use>
                            </svg>
                            <strong>Удобная и быстрая доставка</strong>
                            <p>Мы предлагаем широкий выбор способов получения заказа</p>
                        </div>
                    </div>
                    <div class="preview-slider-navigation">
        ...
        <footer-main class="footer--card"></footer-main>
