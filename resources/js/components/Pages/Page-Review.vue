        ...
        <div id="top-level" class="site-container">
            ...
            <main>
                <div class="bread-crumbs ">
                    ...
                    <a href="#!" aria-current="location">Обзоры</a>
                </div>
                <div class="news">
                    <h1 class="subtitle">Обзоры<sup class="title-counter">34</sup></h1>
                    <div class="news__category slider-container">
                        <div class="news__category-slider slider-container">
                            <div class="news__slider-wrapper swiper-wrapper">
                                ...
                                <label class="news__category-item swiper-slide">
                                    <input class="visually-hidden" type="checkbox" name="Видео">
                                    <span>Видео</span>
                                </label>
                                <label class="news__category-item swiper-slide">
                                    <input class="visually-hidden" type="checkbox" name="Текст">
                                    <span>Текст</span>
                                </label>
                                <label class="news__category-item swiper-slide">
                                    <input class="visually-hidden" type="checkbox" name="Обзоры">
                                    <span>Обзоры</span>
                                </label>
                                <label class="news__category-item swiper-slide">
                                    <input class="visually-hidden" type="checkbox" name="Сравнения">
                                    <span>Сравнения</span>
                                </label>
                                <label class="news__category-item swiper-slide">
                                    <input class="visually-hidden" type="checkbox" name="Краш видео">
                                    <span>Краш видео</span>
                                </label>
                                <label class="news__category-item swiper-slide">
                                    <input class="visually-hidden" type="checkbox" name="Распаковка">
                    ...
                    <div class="news__body">
                        <div class="news__sorting">
                            <fieldset class="sort-fieldset">
                                <legend>Бренд</legend>
                                <label class="sort-fieldset-checkbox">
                        ...
                        <div class="news__content">
                                    ...
                                    <a href="review2" class="article-el__img">
                                        <picture>
                                            ...
                                            <img src="img/content/review/review.jpg" srcset="img/content/review/review@2x.jpg 700w"
                                                 sizes="(max-width: 769px) 100vw, 345px" alt="обзор гаджета" decoding="async" loading="lazy">
                                        </picture>
                                    </a>
                                    <div class="article-el__body">
                                        <h3><a class="text-limiter" href="review2">Iphone 11, почему такой же как и Pro Max, может быть в
                                            3 строки и вот таким большим</a></h3>
                                        <div class="article-el__mark has-video">
                                            <span class="article-el__mark-crush">Краш видео</span>
                                        </div>
                                ...
                                <article class="article-el">
                                    ...
                                    <div class="article-el__body">
                                        <h3><a class="text-limiter" href="review2">Iphone 11, почему такой же как и Pro Max, может быть в
                                            3 строки и вот таким большим</a></h3>
                                        <div class="article-el__mark has-video">
                                            <span class="article-el__mark-review">Обзоры</span>
                                        </div>
                                        <p class="text-limiter"> Видео разбор с ответами на самые часто задаваемые вопросы может быть большим
                                            в 3 строки, видео разбор с ответами на самые часто задаваемые</p>
                                        <a href="review2" class="link">Читать далее</a>
                                ...
                                <article class="article-el">
                                    ...
                                    <div class="article-el__body">
                                        <h3><a class="text-limiter" href="review2">Iphone 11, почему такой же как и Pro Max, может быть в
                                            3 строки и вот таким большим</a></h3>
                                        <div class="article-el__mark has-video">
                                            <span class="article-el__mark-compare">Сравнение</span>
                                        </div>
                                        <p class="text-limiter"> Видео разбор с ответами на самые часто задаваемые вопросы может быть большим
                                            в 3 строки, видео разбор с ответами на самые часто задаваемые</p>
                                        <a href="review2" class="link">Читать далее</a>
                            ...
                            <div class="news__pagination">
                                <button class="btn btn-purple news__more">Показать еще</button>
