<template>
    <fragment>
        ...
        <div id="top-level" class="site-container">
            ...
            <main>
                <div class="service service--policy">
                    ...
                    <div class="service__container">
                        <div class="bread-crumbs ">
                            ...
                            <a href="policy" aria-current="location">Политика конфиденциальности</a>
                        </div>
                        <h1 class="title">Политика в отношении обработки персональных данных</h1>
                        <h2 class="service__title">Общие положения</h2>
                        <div class="service__text-block">
                            <p>Настоящая политика обработки персональных данных составлена в соответствии с требованиями
                                ...
                                меры по обеспечению безопасности персональных данных ИП Демидову Л.И. (далее – Оператор).</p>
                            <ol>
                        ...
                        <h2 class="service__title">Основные понятия, используемые в Политике</h2>
                        <div class="service__text-block">
                            <ol>
                                ...
                                <li>Персональные данные – любая информация, относящаяся прямо или косвенно к определенному или
                                    определяемому Пользователю веб-сайта http://mediashop24.ru/;
                                </li>
                                <li>Пользователь – любой посетитель веб-сайта http://mediashop24.ru/;</li>
